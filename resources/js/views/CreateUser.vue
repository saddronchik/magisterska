...
<!--                            <label for="role">Роль пользователя</label>-->
                            <input type="radio" id="one" value="admin" v-model="picked" v-model.trim="role">
                            <label for="one">Admin</label>
                            <br>
                            <input type="radio" id="two" value="moderator" v-model="picked" v-model.trim="role">
                            <label for="two">Moderator</label>
